...
def populate_table_data_rows(parent, filtered, start_row=8):
    ...
    for system_name, system_data in filtered.items():
        ...
        if (controlling_power == "no power"):
            ...
            if progress > 100 and system_data.getSystemStateText() != "Stronghold":
            ...
            if 0 <= progress < 20:
                ...
                if system_data.getSystemStateText() == "Stronghold":
                    state_bg = "darkgreen"
                else:
                    state_bg = "darkorange"
            state_fg = "white"
        ...
        widgets = [
            ...
            tk.Label(parent, text=state, width=20, anchor="w", font=state_font, bg=state_bg, fg=state_fg),
